...
DOWNLOAD_DIR = f'/media/kokimame/Work_A_1TB/Project/Master_Files/ESC-50-master/audio'
SPEC_DIR = f'/media/kokimame/Work_A_1TB/Project/Master_Files/ESC-50-master/spec'
...
def spec_to_chunks(path, remove_silence=False):
    ...
    for i in range(0, spec_length // CHUNK_WIDTH):
        ...
        if chunk.shape[1] != CHUNK_WIDTH:
            print(f'Invalid Chunk Width Error')
            continue
        if not has_enough_energy(chunk, threshold=0):
